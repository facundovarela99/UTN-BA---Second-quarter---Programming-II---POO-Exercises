...
export class Barco{
    private tipo_navio: string;
    private nombre: string;
    private velocidad: number;
    private capacidadDeCarga: string;
    private flotabilidad: string;
    private estabilidad: string;



    constructor(tipo_navio: string, nombre: string, velocidad: number, capacidad_carga: string, flotabilidad: string, estabilidad: string){
    ...
    public getFlotabilidad(){
        return this.flotabilidad;
    }

    public getEstabilidad(){
